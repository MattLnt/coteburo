...
// (le rayon s'il y en a un, sinon la catégorie), dans l'ordre de l'admin,
// puis les autres par nom. Sans cible, aucune mise en avant ne s'applique :
// « tout le catalogue » reste alphabétique.
