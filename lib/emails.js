        ...
        <tr>
          <td style="background:${C.charcoal};padding:28px 32px;">
            ...
            <p style="margin:0;color:#9aa0a8;font-size:12.5px;line-height:1.6;">
              Techindus D, 645 rue Mayor de Montricher, 13290 Aix-en-Provence<br>
              06 35 584 378 · contact@coteburo.fr
            </p>
  ...
  const contenu = `
    ...
    <tr><td style="padding:0 32px;">
      ...
      <table role="presentation" width="100%" style="margin-top:16px;">
        ...
        <tr><td style="color:${C.inkSoft};font-size:13.5px;padding:3px 0;">${libelleTVA(tauxDepuisMontants(c.totalHT, c.totalTVA))}</td><td style="text-align:right;color:${C.inkSoft};font-size:13.5px;">${euro(c.totalTVA)}</td></tr>
    ...
    <tr><td style="padding:28px 32px 36px;">
      <div style="background:${C.bg};border-radius:12px;padding:18px 20px;">
        ...
        <p style="margin:0;color:${C.inkSoft};font-size:13.5px;line-height:1.6;">
          Contactez-nous directement au 06 35 58 43 78 ou par retour de cet email.
        </p>
      </div>
    </td></tr>
  `;
  ...
  const contenu = `
    ...
    <tr><td style="padding:28px 32px 0;">
      ...
      <table role="presentation" width="100%" style="margin-top:16px;">
        ...
        <tr><td style="color:${C.inkSoft};font-size:13.5px;padding:3px 0;">${libelleTVA(tauxDepuisMontants(d.totalHT, d.totalTVA))}</td><td style="text-align:right;color:${C.inkSoft};font-size:13.5px;">${euro(d.totalTVA)}</td></tr>
    ...
    <tr><td style="padding:28px 32px 36px;">
      <div style="background:${C.bg};border-radius:12px;padding:18px 20px;">
        ...
        <p style="margin:0;color:${C.inkSoft};font-size:13.5px;line-height:1.6;">
          Contactez-nous au 06 35 58 43 78 ou par retour de cet email — nous ajusterons la proposition avec vous.
        </p>
      </div>
    </td></tr>
  `;
