...
const NOM_GAMME = "CHEYENNE";
const NOM_PRODUIT = "Fauteuil";

const COLORIS = [
  { nom: "Noir", couleur: "#23262a", ordre: 0 },
  { nom: "Noir et rouge", couleur: "#8a1f24", ordre: 1 },
];
...
async function main() {
  ...
  await prisma.produitVitrine.update({ where: { id: v.id }, data: {
    axesDeclinaisons: [], declinaisons: [ mk({}, 395, "CHE01..") ],
  } });
  ...
  console.log(`  ✓ ${gamme.nom} / ${v.nom} — prix unique 395€ + 2 coloris`);
  console.log(`\n✓ CHEYENNE traitée.`);
}
