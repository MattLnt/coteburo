    ...
    <section className="mx-auto max-w-[1240px] px-5 sm:px-7 py-14 lg:py-20">
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-14 items-center">
        ...
        <div className="relative aspect-[1/1.02] rounded-[24px] overflow-hidden border border-line shadow-[0_30px_70px_-25px_rgba(33,36,40,0.28)]">
          <Image src="https://images.unsplash.com/photo-1746021535490-cd4d7fe7ab2a?auto=format&fit=crop&w=1100&q=80" alt="Espace de travail aménagé par Côté BURO" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover" priority />
