        ...
        <div className="grid gap-9 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="text-sm leading-7">
              Spécialiste de l'aménagement de petits, moyens et grands espaces à Aix-en-Provence,
              avec une longue expérience dans le mobilier de bureau professionnel.
            </p>
          ...
          <FooterCol title="Services" links={[
            ["Aménagement de bureaux", "/services"],
            ["Plans 3D", "/services"],
            ["Livraison & montage", "/services"],
          ...
          <div>
            ...
            <p className="text-sm leading-7">
              <span className="text-white font-semibold">TECH'INDUS</span> — Bât D, Porte 8<br />
              645 rue Mayor de Montricher<br />
              13290 Aix-en-Provence
            </p>
            <p className="text-sm leading-7 mt-3">
              <a href="tel:0620391390" className="text-white font-semibold hover:text-orange transition">06 20 39 13 90</a><br />
              <a href="mailto:coteburo@orange.fr" className="hover:text-orange transition">coteburo@orange.fr</a>
            </p>
          </div>
        </div>
