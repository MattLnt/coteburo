        ...
        <div className="group relative rounded-[20px] sm:rounded-3xl overflow-hidden bg-charcoal h-[360px] lg:h-[520px] flex-[2_1_600px] min-w-0">
          ...
          <div className="absolute inset-0 p-[22px] sm:p-11 flex flex-col justify-between">
            ...
            <div className="flex gap-2 sm:gap-3 sm:flex-wrap">
              <Link prefetch={false} href="/catalogue" className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 rounded-full bg-orange text-white font-semibold px-4 sm:px-6 py-3 sm:py-3.5 text-[12.5px] sm:text-base hover:bg-orange-dark transition">
        ...
        <div className="grid grid-cols-2 lg:flex lg:flex-col gap-2.5 sm:gap-4 flex-[1_1_300px] min-w-0 w-full lg:w-auto">
          ...
          <div className="group relative rounded-[20px] sm:rounded-3xl overflow-hidden bg-charcoal h-[165px] lg:h-[252px]">
            ...
            <div className="absolute inset-0 p-3.5 sm:p-7 flex flex-col justify-end">
              ...
              <Link prefetch={false} href="/catalogue?categorie=sieges" className="inline-flex items-center gap-1.5 rounded-full bg-white text-ink font-semibold px-3 sm:px-5 py-1.5 sm:py-2.5 text-[11px] sm:text-sm hover:bg-orange hover:text-white transition mt-2 sm:mt-3 self-start">Découvrir →</Link>
            </div>
          </div>
          ...
          <div className="group relative rounded-[20px] sm:rounded-3xl overflow-hidden bg-charcoal h-[165px] lg:h-[252px]">
            ...
            <div className="absolute inset-0 p-3.5 sm:p-7 flex flex-col justify-end">
              ...
              <Link prefetch={false} href="/catalogue?categorie=bureaux" className="inline-flex items-center gap-1.5 rounded-full bg-white text-ink font-semibold px-3 sm:px-5 py-1.5 sm:py-2.5 text-[11px] sm:text-sm hover:bg-orange hover:text-white transition mt-2 sm:mt-3 self-start">Découvrir →</Link>
            </div>
          </div>
