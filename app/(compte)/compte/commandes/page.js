  ...
  return (
    <div>
      <div className="mb-5 sm:mb-8">
        ...
        <h1 className="font-display font-bold text-[26px] sm:text-4xl mt-1.5 sm:mt-2">Mes commandes</h1>
        <p className="text-ink-soft mt-1.5 sm:mt-2 text-[13px] sm:text-base">Historique et suivi de toutes vos commandes.</p>
      </div>
