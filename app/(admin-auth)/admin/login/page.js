            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required autoComplete="email"
                  className="w-full rounded-xl border border-line bg-surface pl-11 pr-4 py-3.5 text-sm text-ink outline-none focus:border-orange transition" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={showPwd ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} required autoComplete="current-password"
                  className="w-full rounded-xl border border-line bg-surface pl-11 pr-11 py-3.5 text-sm text-ink outline-none focus:border-orange transition" />
